...
var board_data; //gets populated in hidden scope
...
(function() {
	...
	board_data = sudokuStructure(board_dom); // populates global variable 'board_data'
	...
	init_dom.userReset = function(box_count, box_width) {
		...
		if (init_dom.userReset.generatePuzzle) {
			init_dom.userReset.generatePuzzle(board_dom, board_data);
		}
	};
